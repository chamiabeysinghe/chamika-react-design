...
const Widget2 = (props) =>{
    return(
              ...
              <div>
                ...
                <div className="card card-xxl-stretch mb-5 mb-xl-10" style={{backgroundColor: props.color}}>
                  {/*begin::Body*/}
                  <div className="card-body d-flex flex-column">
                    {/*begin::Wrapper*/}
                    <div className="d-flex flex-column mb-7">
                      {/*begin::Title*/}
                      <a href="/" className="text-dark text-hover-primary fw-bolder fs-3">{props.title}</a>
                      {/*end::Title*/}
                    </div>
                    {/*end::Wrapper*/}
                    {/*begin::Row*/}
                    <div className="row g-0">
                      ...
                      <div className="col-6">
                        <div className="d-flex align-items-center mb-9 me-2">
                          ...
                          {/*begin::Title*/}
                          <div>
                            <div className="fs-5 text-dark fw-bolder lh-1">{props.amount}</div>
                            <div className="fs-7 text-gray-600 fw-bold">{props.sale}</div>
                          </div>
                          {/*end::Title*/}
                        </div>
                      </div>
                      ...
                      <div className="col-6">
                        <div className="d-flex align-items-center mb-9 ms-2">
                          ...
                          {/*begin::Title*/}
                          <div>
                            <div className="fs-5 text-dark fw-bolder lh-1">{props.revenuAmount}</div>
                            <div className="fs-7 text-gray-600 fw-bold">{props.revenu}</div>
                          </div>
                          {/*end::Title*/}
                        </div>
                      </div>
                      ...
                      <div className="col-6">
                        <div className="d-flex align-items-center me-2">
                          ...
                          {/*begin::Title*/}
                          <div>
                            <div className="fs-5 text-dark fw-bolder lh-1">{props.num}</div>
                            <div className="fs-7 text-gray-600 fw-bold">{props.task}</div>
                          </div>
                          {/*end::Title*/}
                        </div>
                      </div>
                      ...
                      <div className="col-6">
                        <div className="d-flex align-items-center ms-2">
                          ...
                          {/*begin::Title*/}
                          <div>
                            <div className="fs-5 text-dark fw-bolder lh-1">{props.value}</div>
                            <div className="fs-7 text-gray-600 fw-bold">{props.sale}</div>
                          </div>
                          {/*end::Title*/}
                        </div>

...
function LayOutNotice(){
    return(
        ...
        <div className="card-body d-flex align-items-center p-5 p-lg-8">
          {/*begin::Icon*/}
          <div className="d-flex h-50px w-50px h-lg-80px w-lg-80px flex-shrink-0 flex-center position-relative align-self-start align-self-lg-center mt-3 mt-lg-0">
            {/*begin::Svg Icon | path: icons/duotune/abstract/abs051.svg*/}
            <span className="svg-icon svg-icon-primary position-absolute opacity-15">
              <svg xmlns="http://www.w3.org/2000/svg" width="70px" height="70px" viewBox="0 0 70 70" fill="none" className="h-50px w-50px h-lg-80px w-lg-80px">
          ...
          {/*begin::Description*/}
          <div className="ms-6">
            <p className="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">The layout builder is to assist your set and configure your preferred project layout specifications and preview it in real time and export the HTML template with its includable partials of this demo. The downloaded version does not include the assets folder since the layout builder's main purpose is to help to generate the final HTML code without hassle.</p>
          </div>
          {/*end::Description*/}
        </div>
      </div>

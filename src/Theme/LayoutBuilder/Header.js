...
function Header(){
    return(
        ...
        {/*begin::Container*/}
        <div className="container d-flex align-items-center justify-content-between" id="kt_header_container">
          {/*begin::Page title*/}
          <div className="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
            {/*begin::Heading*/}
            <h1 className="d-flex flex-column text-dark fw-bolder my-0 fs-1">Layout Builder</h1>
            {/*end::Heading*/}
            {/*begin::Breadcrumb*/}
            <ul className="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
              <li className="breadcrumb-item text-muted">
                <a href="index.html" className="text-muted">Home</a>
              </li>
              <li className="breadcrumb-item text-dark">Layout Builder</li>
            </ul>
            {/*end::Breadcrumb*/}
          </div>
          {/*end::Page title=*/}
          ...
          <div className="d-flex d-lg-none align-items-center ms-n2 me-2">
            ...
            <a href="index.html" className="d-flex align-items-center">
              <img alt="Logo" src="assets/media/logos/logo-demo3-default.svg" className="h-20px" />
            </a>
            {/*end::Logo*/}
          </div>
          {/*end::Wrapper*/}
          ...
          <div className="d-flex align-items-center flex-shrink-0">
            {/*begin::Search*/}
            <div id="kt_header_search" className="d-flex align-items-center w-125px w-md-150px w-lg-225px" data-kt-search-keypress="true" data-kt-search-min-length={2} data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end">
              {/*begin::Form*/}
              <form data-kt-search-element="form" className="w-100 position-relative" autoComplete="off">
                ...
                {/*end::Icon*/}
                {/*begin::Input*/}
                <input type="text" className="form-control bg-transparent ps-13 fs-7 h-40px" name="search" defaultValue placeholder="Quick Search" data-kt-search-element="input" />
                {/*end::Input*/}
                {/*begin::Spinner*/}
              ...
              {/*end::Form*/}
              {/*begin::Menu*/}
              <div data-kt-search-element="content" className="menu menu-sub menu-sub-dropdown w-300px w-md-350px py-7 px-7 overflow-hidden">
                {/*begin::Wrapper*/}
...
*/}
            ...
            <div className="d-flex align-items-center ms-3 ms-lg-4">
              {/*begin::Drawer toggle*/}
              <div className="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline btn-outline-secondary w-40px h-40px" id="kt_activities_toggle">
            ...
            {/*end::Activities*/}
            {/*begin::Chat*/}
            <div className="d-flex d-none align-items-center ms-3 ms-lg-4">
              {/*begin::Drawer wrapper*/}
              <div className="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline btn-outline-secondary position-relative w-40px h-40px" id="kt_drawer_chat_toggle">
            ...
            <button className="btn btn-icon btn-active-icon-primary d-xxl-none ms-2 me-n2" id="kt_sidebar_toggler">
              {/*begin::Svg Icon | path: icons/duotune/coding/cod001.svg*/}

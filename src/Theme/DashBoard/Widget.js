    ...
    return(
        <div className="row gy-5 g-xl-10">
                ...
                <div className="card card-xl-stretch mb-xl-10" style={{backgroundColor: '#F7D9E3'}}>
                  ...
                  <div className="card-body d-flex flex-column">
                    ...
                    <div className="d-flex flex-column flex-grow-1">
                      {/*begin::Title*/}
                      <a href="#" className="text-dark text-hover-primary fw-bolder fs-3">Earnings</a>
                      {/*end::Title*/}
                      {/*begin::Chart*/}
                      <div className="mixed-widget-13-chart" style={{height: '100px'}} />
                      {/*end::Chart*/}
                    </div>
                    {/*end::Wrapper*/}
                    {/*begin::Stats*/}
              ...
              <div className="col-xl-4">
                ...
                <div className="card card-xxl-stretch mb-xl-10" style={{backgroundColor: '#CBF0F4'}}>
                  {/*begin::Body*/}
                  <div className="card-body d-flex flex-column">
                    {/*begin::Wrapper*/}
                    <div className="d-flex flex-column flex-grow-1">
                      {/*begin::Title*/}
                      <a href="#" className="text-dark text-hover-primary fw-bolder fs-3">Contributors</a>
                      {/*end::Title*/}
                      {/*begin::Chart*/}
                      <div className="mixed-widget-14-chart" style={{height: '100px'}} />
                      {/*end::Chart*/}
                    </div>
                    {/*end::Wrapper*/}
                    {/*begin::Stats*/}
              ...
              <div className="col-xl-4">
                {/*begin::Mixed Widget 14*/}
                <div className="card card-xxl-stretch mb-5 mb-xl-10" style={{backgroundColor: '#CBD4F4'}}>
                  {/*begin::Body*/}
                  <div className="card-body d-flex flex-column">
                    {/*begin::Wrapper*/}
                    <div className="d-flex flex-column mb-7">
                      {/*begin::Title*/}
                      <a href="#" className="text-dark text-hover-primary fw-bolder fs-3">Summary</a>
                      {/*end::Title*/}
                    </div>
                    {/*end::Wrapper*/}
                    {/*begin::Row*/}
